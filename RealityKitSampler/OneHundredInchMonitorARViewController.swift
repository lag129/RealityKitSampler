...
class OneHundredInchMonitorARViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, ARCoachingOverlayViewDelegate {
    ...
    func addMonitorEntity() {
        ...
        displayEntity.position = [0,1,0.03]
        
        if let videoURL = Bundle.main.url(forResource: "kaiseki", withExtension: "mp4") {
...
//        anchorEntity = AnchorEntity(plane: .vertical)
//        
//        if let imageURL = Bundle.main.url(forResource: "1", withExtension: "png") {
//            let stickerImage = AVURLAsset(url: imageURL)
//        }
//
//        anchorEntity.addChild(stickerImage)
//    }
